...
export default function VCProfilePage(props: { 
  ...
  const vcData = use(getVCData(params.slug));
  ...
  const { reviews, totalReviews, currentPage, totalPages } = use(getVCReviews(vcData.id, page));
